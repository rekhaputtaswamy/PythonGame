...
carImg = pygame.image.load('/Users/rekhap/CarRaceGamePython/car.png')
carLeft = pygame.image.load('/Users/rekhap/CarRaceGamePython/car.png')
carRight = pygame.image.load('/Users/rekhap/CarRaceGamePython/car.png')
obstacle_Img = pygame.image.load('/Users/rekhap/CarRaceGamePython/obstacle.png')
textur = pygame.image.load('/Users/rekhap/CarRaceGamePython/texture.png')
...
logo = pygame.image.load('/Users/rekhap/CarRaceGamePython/logo.jpg')
pygame.display.set_icon(logo)

background = pygame.image.load('/Users/rekhap/CarRaceGamePython/background.jpg')
background_still = pygame.image.load('/Users/rekhap/CarRaceGamePython/background_inv.png')
backgroundRect = background.get_rect()

intro_1 = pygame.mixer.Sound('/Users/rekhap/CarRaceGamePython/intro1.wav')
intro_2 = pygame.mixer.Sound('/Users/rekhap/CarRaceGamePython/intro2.wav')
crash_sound = pygame.mixer.Sound('/Users/rekhap/CarRaceGamePython/car_crash.wav')
ignition = pygame.mixer.Sound('/Users/rekhap/CarRaceGamePython/ignition.wav')
pygame.mixer.music.load('/Users/rekhap/CarRaceGamePython/running.wav')

def things_dodged(count, high_score, thing_speed):
	font = pygame.font.SysFont(None, 25)
	score = font.render("Dodged: "+str(count), True, red)
	highscore = font.render("High Score: "+str(high_score), True, red)
	speed = font.render("Speed: "+str(thing_speed)+"Km/h", True, red)
...
def high_score_update(dodged):
	hs = open('/Users/rekhap/CarRaceGamePython/high_score.txt', 'w')
	temp = str(dodged)
	hs.write(temp)
...
def title_msg(shift_x, shift_y, color):
	...
	TextSurf, TextRect = text_objects("Road Rush", largeText, color)
...
def crash():
	...
	message_display("CAR CRASHED", 0, 0, red,0)
	while True:
		play = button("Replay", button_start_x, new_game_y, button_width, button_height, blueLight, blue)
		quit_game = button("Exit", button_start_x, quit_y, button_width, button_height, redLight, red)
	...
	while intro:
		for event in pygame.event.get():
			if event.type == pygame.QUIT or quit_game == 1 or (event.type == pygame.KEYDOWN and event.key == pygame.K_ESCAPE):
				pygame.quit()
				quit()
		play = button("New game", button_start_x, new_game_y, button_width, button_height, blueLight, blue)
		quit_game = button("Exit", button_start_x, quit_y, button_width, button_height, redLight, red)
...
def game_play():
	...
	high_score_file = open('/Users/rekhap/CarRaceGamePython/high_score.txt','r')
